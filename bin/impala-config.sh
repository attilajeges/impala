...
export IMPALA_TOOLCHAIN_BUILD_ID=132-438c7ad34b
...
if $USE_CDH_KUDU; then
  export IMPALA_KUDU_VERSION="1.11.0-cdh6.x-SNAPSHOT"
  ...
  export IMPALA_TOOLCHAIN_KUDU_MAVEN_REPOSITORY="file://${IMPALA_TOOLCHAIN}"
  export IMPALA_TOOLCHAIN_KUDU_MAVEN_REPOSITORY_ENABLED=false
else
  export IMPALA_KUDU_VERSION="3ba5ec5d0"
